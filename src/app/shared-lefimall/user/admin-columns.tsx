...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title="담당자 연락처" />,
    dataIndex: 'mobile',
    key: 'mobile',
    width: 150,
    render: (value: string) => (
    ...
    render: (_: string, row: any) => (
      <div className="flex items-center justify-end gap-3 pe-4">
        ...
        */}
        ...
        <DeletePopover
          title={`Delete`}
          description={`${row.id}번 계정을 Are you sure you want to delete?`}
        ...
        <Tooltip
          ...
          color="invert"
        >
          <Link href={routes.user.adminDetails(row.id)}>
            <ActionIcon
              tag="span"
              size="sm"
              variant="outline"
