...
// icons for grid of 3x2
// {/* 나의 정보, 나의 저작권, 나의 수익, Q&A, 문의하기, 공지사합 */}
      ...
      {session?.user?.email ? (
              ...
              <div className="flex flex-col items-center justify-center gap-5 border border-gray-200 rounded-lg p-5 
                ...
                >
                  ...
                  <div className="relative w-full ">
                    ...
                    {/* HiOutlineUser */}
                    <HiOutlineUser size={80} color="gray" />
              ...
              <div className="flex flex-col items-center justify-center gap-5 border border-gray-200 rounded-lg p-5 
                ...
                >
                  ...
                  <div className="relative w-full ">
                    ...
                    <HiOutlineDocumentText size={80} color="gray" />
              ...
              <div className="flex flex-col items-center justify-center gap-5 border border-gray-200 rounded-lg p-5 
                ...
                >
                  ...
                  <div className="relative w-full ">
                      ...
                      <HiOutlineCurrencyDollar size={80} color="gray" />
                  </div>
              ...
              <div className="flex flex-col items-center justify-center gap-5 border border-gray-200 rounded-lg p-5 
                ...
                >
                  ...
                  <div className="relative w-full ">
                    ...
                    <HiOutlineQuestionMarkCircle size={80} color="gray" />
              ...
              <div className="flex flex-col items-center justify-center gap-5 border border-gray-200 rounded-lg p-5 
                ...
                >
                  ...
                  <div className="relative w-full ">
                    ...
                    <HiOutlineChatAlt2 size={80} color="gray" />
              ...
              <div className="flex flex-col items-center justify-center gap-5 border border-gray-200 rounded-lg p-5 
                ...
                >
                  ...
                  <div className="relative w-full ">
                    ...
                    <HiOutlineBell size={80} color="gray" />
        ...
        <div className=" mt-10 xl:mt-28 flex flex-col items-center justify-center gap-5 xl:gap-10">
          ...
          */}
          ...
          <Image
            src="/images/corky/home-banner.png"
            alt="Logo"
            width={500}
            height={500}
