...
type ColumnTypes = {
  ...
  onClickShop: (id: string) => void; // shop profile
};
...
const [loadingShopList, setLoadingShopList] = useState(true);


useEffect(() => {
  const fetchData = async () => {

    setLoadingShopList(true);
  ...
  const onClickShop = (id: string) => {

    openDrawer({
        view: <ShopProfile id={id} />,
        placement: 'right',
    });
          ...
          <div className='flex flex-wrap items-center justify-start gap-3'>
            ...
            */}
            ...
            <div className='flex flex-col items-center justify-start gap-5'>
              ...
              {/* 카테고리 select box  카테고리1, 카테고리2, 카테고리3, 카테고리4 */}
              ...
              {userData && !userData?.shopId && (
                <div className='flex  items-center justify-start gap-3'>
                  <div className=' w-20'>
                    Merchant
                  </div>

                  {/* select option have image */}
                  {/* setSearchTerm */}


                  <Select

                    // if selected option is changed, set selected shop id for option value
                    //value={searchTerm}
                    ...
                    onChange={(value: any) => {
                      console.log('shop select value ->', value);
                      //setSearchTerm(value);
                      //handleSearch(value);

                      setSelectedShopId(value);
                      handleSelectedShopId(value);

                    } }


                    // default selected option is all
                    ...
                    placeholder={ loadingShopList ? 'Loading...' :
                      shopList.length === 0 ? '입점업체 없음' :
                      // selected shop id
                      //'입점업체 선택'
                    ...
                    options = {
                      ...
                      [
                        ...
                        loadingShopList ? [] : shopList.map((shop: any) => (
                          {
                          ...
                          // image: shop?.image,
                          //////image: shop?.image ? shop?.image : 'https://via.placeholder.com/150',
  
  
                          // customLabel: (
  
                          // enable custom label have image
  
                          label: (
                            <div className="flex flex-row items-center justify-start gap-3">
                              <div className="flex-shrink-0 w-6 h-6">
                                <img
                                  src={shop?.avatar ? shop?.avatar : '/logo.png'}
                                  alt=""
